...
#    options['HLTFILTERTOMEASURE']  = cms.vstring("")
    options['TnPPATHS']            = cms.vstring("HLT_Ele35_WPTight_Gsf_v*")#,"HLT_Ele115_CaloIdVT_GsfTrkIdT*"
    options['TnPHLTTagFilters']    = cms.vstring("hltEle35noerWPTightGsfTrackIsoFilter")
    options['TnPHLTProbeFilters']  = cms.vstring()
    options['HLTFILTERTOMEASURE']  = cms.vstring("hltEle35noerWPTightGsfTrackIsoFilter")   
...
filesMC =  cms.untracked.vstring(
        '/store/mc/RunIIFall17MiniAODv2/DYJetsToLL_M-50_Zpt-150toInf_TuneCP5_13TeV-madgraphMLM-pythia8/MINIAODSIM/PU2017RECOSIMstep_12Apr2018_94X_mc2017_realistic_v14-v1/80000/F2D591F4-90A9-E811-87C3-A4BF01125B08.root',
    )
