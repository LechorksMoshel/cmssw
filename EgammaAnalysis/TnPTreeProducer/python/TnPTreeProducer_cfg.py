...
options['isEarly2017']          = cms.bool(False)
...
#     options['HLTFILTERTOMEASURE']  = cms.vstring("hltEle27erWPTightGsfTrackIsoFilter") #FOR 2016
    options['TnPPATHS']            = cms.vstring("HLT_Ele35_WPTight_Gsf_v*","HLT_Ele115_CaloIdVT_GsfTrkIdT_v*","HLT_Photon200_v*")
    ...
    options['TnPHLTProbeFilters']  = cms.vstring()
    options['HLTFILTERTOMEASURE']  = cms.vstring("hltEle35noerWPTightGsfTrackIsoFilter","hltEle115CaloIdVTGsfTrkIdTGsfDphiFilter","hltEG200HEFilter")
...
if varOptions.isEarly2017:#Ele115 introduced in 2017C
    options['isEarly2017']=cms.bool(True)
