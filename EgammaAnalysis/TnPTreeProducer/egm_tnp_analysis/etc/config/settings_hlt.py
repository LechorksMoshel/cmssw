...
baseOutDir = 'results/Data2017/tnpEleHLT/'
...
samplesDef = {
    'data'   : tnpSamples.Data2017_10_1_X['data'].clone(),
    'mcNom'  : tnpSamples.Data2017_10_1_X['mc'].clone(),
    'mcAlt'  : tnpSamples.Data2017_10_1_X['mc'].clone(),
    'tagSel' : tnpSamples.Data2017_10_1_X['mc'].clone(),
}
...
biningDef = [
   ...
   { 'var' : 'el_pt' , 'type': 'float', 'bins': [ 45,50,55,60,65,70,75,80,90,100,110,120,130,140,160,180,200,240,280,320,360,500,1000] },
]
#biningDef = [
#   { 'var' : 'el_sc_eta' , 'type': 'float', 'bins': [-2.5,-2.0,-1.566,-1.4442, -0.8, 0.0, 0.8, 1.4442, 1.566, 2.0, 2.5] },
#   { 'var' : 'el_pt' , 'type': 'float', 'bins': [200,240,280,320,360,500,1000] },
#]

#test bin
#biningDef = [
#   { 'var' : 'el_sc_eta' , 'type': 'float', 'bins': [-2.5, -1.566, 0.0, 1.566, 2.5] },
#   { 'var' : 'el_pt' , 'type': 'float', 'bins': [500,1000] },
#]
...
#############################################################
### cut
cutBase   = 'tag_Ele_pt > 30 && abs(tag_sc_eta) < 2.17 && el_q*tag_Ele_q < 0 && passingTight94X'
