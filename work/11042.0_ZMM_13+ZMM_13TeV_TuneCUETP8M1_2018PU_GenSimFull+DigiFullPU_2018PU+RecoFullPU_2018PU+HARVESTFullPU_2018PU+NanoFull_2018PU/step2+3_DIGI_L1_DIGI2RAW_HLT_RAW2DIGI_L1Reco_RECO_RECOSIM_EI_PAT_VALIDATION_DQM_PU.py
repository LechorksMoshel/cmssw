...
# with command line options: step2+3 --conditions auto:phase1_2018_realistic --pileup_input das:/RelValMinBias_13/CMSSW_10_3_0_pre5-103X_upgrade2018_realistic_v7-v1/GEN-SIM -n 10 --era Run2_2018 --eventcontent RECOSIM,MINIAODSIM,DQM --runUnscheduled -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2018,RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT,VALIDATION:@standardValidation+@miniAODValidation,DQM:@standardDQM+@ExtraHLT+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --pileup AVE_50_BX_25ns --geometry DB:Extended --filein file:step1.root --fileout file:step3.root
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step2+3 nevts:10'),
