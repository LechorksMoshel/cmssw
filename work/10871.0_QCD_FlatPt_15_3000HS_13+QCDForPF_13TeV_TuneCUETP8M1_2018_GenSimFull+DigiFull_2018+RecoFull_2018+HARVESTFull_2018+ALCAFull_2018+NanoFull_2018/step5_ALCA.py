...
# with command line options: step5 --conditions auto:phase1_2018_realistic -n 10 --era Run2_2018 --eventcontent ALCARECO --filein file:step3.root -s ALCA:TkAlMuonIsolated+TkAlMinBias+MuAlOverlaps+EcalESAlign+TkAlZMuMu+HcalCalHBHEMuonFilter+TkAlUpsilonMuMu+TkAlJpsiMuMu+SiStripCalMinBias --datatier ALCARECO --geometry DB:Extended --fileout file:step5.root
...
# Schedule definition
process.schedule = cms.Schedule(process.pathALCARECOEcalESAlign,process.pathALCARECOTkAlJpsiMuMu,process.pathALCARECOTkAlMinBias,process.pathALCARECOMuAlOverlaps,process.pathALCARECOMuAlOverlapsGeneralTracks,process.pathALCARECOTkAlZMuMu,process.pathALCARECOTkAlMuonIsolated,process.pathALCARECOSiStripCalMinBias,process.pathALCARECOHcalCalHBHEMuonFilter,process.pathALCARECOTkAlUpsilonMuMu,process.endjob_step,process.ALCARECOStreamEcalESAlignOutPath,process.ALCARECOStreamHcalCalHBHEMuonFilterOutPath,process.ALCARECOStreamMuAlOverlapsOutPath,process.ALCARECOStreamSiStripCalMinBiasOutPath,process.ALCARECOStreamTkAlJpsiMuMuOutPath,process.ALCARECOStreamTkAlMinBiasOutPath,process.ALCARECOStreamTkAlMuonIsolatedOutPath,process.ALCARECOStreamTkAlUpsilonMuMuOutPath,process.ALCARECOStreamTkAlZMuMuOutPath)
