...
config.General.requestName = 'QCD_FlatPT_DIGI_L1_DIGI2RAW_HLT_PU'
config.General.workArea = 'Crab3Area_step2'
...
config.JobType.maxMemoryMB = 4100 #step2 turn out to use a lot
config.JobType.maxJobRuntimeMin = 500 #Should not take too long
...
config.Data.inputDataset = '/QCD_FlatPT_2018_PU_HEDepth_GEN/syuan-QCD_FlatPT_2018_PU_HEDepth_GEN-4a34c468fd7950baae62a6145c3ef912/USER'
config.Data.outLFNDirBase = '/store/user/syuan/QCD_FlatPT'  
config.Data.publication = True
config.Data.outputDatasetTag = 'QCD_FlatPT_2018_PU_HEDepth_DIGI_L1_DIGI2RAW_HLT'
