...
run2_HCAL_2018.toModify(packedPFCandidates,
    pfCandidateTypesForHcalDepth = cms.vint32(130,11,22,211),  # PF candidate types for adding Hcal depth energy fraction information (130: neutral hadron, 11: PF electron, 22: PF photon)
